...
void mainImage(out vec4 o, vec2 C){
  ...
  // Adjust tuv.y to keep warm colors (orange/pink) at top and black at bottom
  // Add offset to push black downward regardless of warping
  float adjustedY = tuv.y - 0.3; // Negative offset pushes black down
  vec3 col=mix(layer1,layer2,S(v0,v1,adjustedY));
